...
/* BeginDocumentation
Name: aeif_cond_alpha_mod - Perfect integrate-and-fire neuron model with alpha PSC synapse.

Description:
aeif_cond_alpha_mod implements a non-leaky integrate-and-fire neuron with
