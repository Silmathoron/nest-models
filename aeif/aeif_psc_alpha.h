...
/* BeginDocumentation
Name: aeif_psc_alpha - Perfect integrate-and-fire neuron model with alpha PSC synapse.

Description:
aeif_psc_alpha implements a non-leaky integrate-and-fire neuron with
...
class aeif_psc_alpha : public nest::Archiving_Node
{
   public:
      /**
   ...
   private:
      ...
      friend class nest::RecordablesMap< aeif_psc_alpha >;
      friend class nest::UniversalDataLogger< aeif_psc_alpha >;
   ...
   public:
      ...
      */
      struct Buffers_
      {
         ...
         nest::UniversalDataLogger< aeif_psc_alpha > logger_;
      ...
      */
      ...
      static nest::RecordablesMap< aeif_psc_alpha > recordablesMap_;

      /** @} */
};

inline nest::port
mynest::aeif_psc_alpha::send_test_event( nest::Node& target,
...
inline nest::port
mynest::aeif_psc_alpha::handles_test_event( nest::SpikeEvent&, nest::port receptor_type )
{
  // You should usually not change the code in this function.
...
inline nest::port
mynest::aeif_psc_alpha::handles_test_event( nest::CurrentEvent&, nest::port receptor_type )
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline nest::port
mynest::aeif_psc_alpha::handles_test_event( nest::DataLoggingRequest& dlr, nest::port receptor_type )
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
