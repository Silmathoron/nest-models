/*
 *  aeif_cond_alpha_mod.cpp
 *
 */

#include "aeif_cond_alpha_mod.h"
...
nest::RecordablesMap< mynest::aeif_cond_alpha_mod > mynest::aeif_cond_alpha_mod::recordablesMap_;
...
namespace nest // template specialization must be placed in namespace
{
  ...
  template <>
  void
  RecordablesMap< mynest::aeif_cond_alpha_mod >::create()
  {
    insert_( names::V_m, &mynest::aeif_cond_alpha_mod::get_y_elem_< mynest::aeif_cond_alpha_mod::State_::V_M > );
    insert_( names::g_ex, &mynest::aeif_cond_alpha_mod::get_y_elem_< mynest::aeif_cond_alpha_mod::State_::G_EXC > );
    insert_( names::g_in, &mynest::aeif_cond_alpha_mod::get_y_elem_< mynest::aeif_cond_alpha_mod::State_::G_INH > );
    insert_( names::w, &mynest::aeif_cond_alpha_mod::get_y_elem_< mynest::aeif_cond_alpha_mod::State_::W > );
  }
}
...
extern "C" int
mynest::aeif_cond_alpha_mod_dynamics( double, const double y[], double f[], void* pnode )
{
  // a shorthand
  typedef mynest::aeif_cond_alpha_mod::State_ S;

  // get access to node so we can almost work as in a member function
  assert( pnode );
  const mynest::aeif_cond_alpha_mod& node = *( reinterpret_cast< mynest::aeif_cond_alpha_mod* >( pnode ) );
...
mynest::aeif_cond_alpha_mod::Parameters_::Parameters_()
...
mynest::aeif_cond_alpha_mod::State_::State_( const Parameters_& p )
  : r_( 0 )
{
  y_[ 0 ] = p.E_L;
...
mynest::aeif_cond_alpha_mod::State_::State_( const State_& s )
  : r_( s.r_ )
{
...
mynest::aeif_cond_alpha_mod::State_& mynest::aeif_cond_alpha_mod::State_::operator=( const State_& s )
{
...
void
mynest::aeif_cond_alpha_mod::Parameters_::get( DictionaryDatum& d ) const
{
...
void
mynest::aeif_cond_alpha_mod::Parameters_::set( const DictionaryDatum& d )
{
...
void
mynest::aeif_cond_alpha_mod::State_::get( DictionaryDatum& d ) const
{
...
void
mynest::aeif_cond_alpha_mod::State_::set( const DictionaryDatum& d, const Parameters_& )
{
...
mynest::aeif_cond_alpha_mod::Buffers_::Buffers_( aeif_cond_alpha_mod& n )
  : logger_( n )
  , s_( 0 )
  , c_( 0 )
  , e_( 0 )
...
mynest::aeif_cond_alpha_mod::Buffers_::Buffers_( const Buffers_&, aeif_cond_alpha_mod& n )
  : logger_( n )
  , s_( 0 )
  , c_( 0 )
  , e_( 0 )
...
mynest::aeif_cond_alpha_mod::aeif_cond_alpha_mod()
  : Archiving_Node()
  , P_()
  , S_( P_ )
  , B_( *this )
...
mynest::aeif_cond_alpha_mod::aeif_cond_alpha_mod( const aeif_cond_alpha_mod& n )
  : Archiving_Node( n )
  , P_( n.P_ )
  , S_( n.S_ )
  , B_( n.B_, *this )
...
void
mynest::aeif_cond_alpha_mod::init_state_( const Node& proto )
{
  const aeif_cond_alpha_mod& pr = downcast< aeif_cond_alpha_mod >( proto );
  S_ = pr.S_;
}

void
mynest::aeif_cond_alpha_mod::init_buffers_()
{
  ...
  B_.sys_.function = aeif_cond_alpha_mod_dynamics;
...
void
mynest::aeif_cond_alpha_mod::calibrate()
{
...
void
mynest::aeif_cond_alpha_mod::update( const Time& origin, const nest::long_t from, const nest::long_t to )
{
...
void
mynest::aeif_cond_alpha_mod::handle( SpikeEvent& e )
{
...
void
mynest::aeif_cond_alpha_mod::handle( CurrentEvent& e )
{
  assert( e.get_delay() > 0 );
...
void
mynest::aeif_cond_alpha_mod::handle( DataLoggingRequest& e )
{
  B_.logger_.handle( e );
}
