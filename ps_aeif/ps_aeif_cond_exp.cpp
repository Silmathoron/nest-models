/*
 *  ps_aeif_cond_exp.cpp
 *
 */

#include "ps_aeif_cond_exp.h"
...
nest::RecordablesMap< mynest::ps_aeif_cond_exp > mynest::ps_aeif_cond_exp::recordablesMap_;
...
namespace nest // template specialization must be placed in namespace
{
  ...
  template <>
  void
  RecordablesMap< mynest::ps_aeif_cond_exp >::create()
  {
    insert_( names::V_m, &mynest::ps_aeif_cond_exp::get_y_elem_< mynest::ps_aeif_cond_exp::State_::V_M > );
    insert_( names::g_ex, &mynest::ps_aeif_cond_exp::get_y_elem_< mynest::ps_aeif_cond_exp::State_::G_EXC > );
    insert_( names::g_in, &mynest::ps_aeif_cond_exp::get_y_elem_< mynest::ps_aeif_cond_exp::State_::G_INH > );
    insert_( names::w, &mynest::ps_aeif_cond_exp::get_y_elem_< mynest::ps_aeif_cond_exp::State_::W > );
  }
}
...
extern "C" int
mynest::ps_aeif_cond_exp_dynamics( double, const double y[], double f[], void* pnode )
{
  // a shorthand
  typedef mynest::ps_aeif_cond_exp::State_ S;

  // get access to node so we can almost work as in a member function
  assert( pnode );
  const mynest::ps_aeif_cond_exp& node = *( reinterpret_cast< mynest::ps_aeif_cond_exp* >( pnode ) );
...
mynest::ps_aeif_cond_exp::Parameters_::Parameters_()
...
mynest::ps_aeif_cond_exp::State_::State_( const Parameters_& p )
  : r_( 0 )
  , r_offset_ ( 0. )
{
  y_[ 0 ] = p.E_L;
...
mynest::ps_aeif_cond_exp::State_::State_( const State_& s )
  : r_( s.r_ )
...
mynest::ps_aeif_cond_exp::State_& mynest::ps_aeif_cond_exp::State_::operator=( const State_& s )
{
...
void
mynest::ps_aeif_cond_exp::Parameters_::get( DictionaryDatum& d ) const
{
...
void
mynest::ps_aeif_cond_exp::Parameters_::set( const DictionaryDatum& d )
{
...
void
mynest::ps_aeif_cond_exp::State_::get( DictionaryDatum& d ) const
{
...
void
mynest::ps_aeif_cond_exp::State_::set( const DictionaryDatum& d, const Parameters_& )
{
...
mynest::ps_aeif_cond_exp::Buffers_::Buffers_( ps_aeif_cond_exp& n )
  : logger_( n )
  , s_( 0 )
  , c_( 0 )
  , e_( 0 )
...
mynest::ps_aeif_cond_exp::Buffers_::Buffers_( const Buffers_&, ps_aeif_cond_exp& n )
  : logger_( n )
  , s_( 0 )
  , c_( 0 )
  , e_( 0 )
...
mynest::ps_aeif_cond_exp::ps_aeif_cond_exp()
  : Archiving_Node()
  , P_()
  , S_( P_ )
  , B_( *this )
...
mynest::ps_aeif_cond_exp::ps_aeif_cond_exp( const ps_aeif_cond_exp& n )
  : Archiving_Node( n )
  , P_( n.P_ )
  , S_( n.S_ )
  , B_( n.B_, *this )
...
void
mynest::ps_aeif_cond_exp::init_state_( const Node& proto )
{
  const ps_aeif_cond_exp& pr = downcast< ps_aeif_cond_exp >( proto );
  S_ = pr.S_;
}

void
mynest::ps_aeif_cond_exp::init_buffers_()
{
  ...
  B_.sys_.function = ps_aeif_cond_exp_dynamics;
...
void
mynest::ps_aeif_cond_exp::calibrate()
{
...
double
mynest::ps_aeif_cond_exp::interpolate_( double& t, double t_old )
{
...
void
mynest::ps_aeif_cond_exp::update( const Time& origin, const nest::long_t from, const nest::long_t to )
{
  ...
  */
  ...
  for ( long_t lag = from; lag < to; ++lag )
  {
    ...
    while ( t < B_.step_ )
    {
      ...
      S_.y_[ State_::G_EXC ] += spike_effect_ex;
      S_.y_[ State_::G_INH ] += spike_effect_in;
    }
...
void
mynest::ps_aeif_cond_exp::handle( SpikeEvent& e )
{
...
void
mynest::ps_aeif_cond_exp::handle( CurrentEvent& e )
{
  assert( e.get_delay() > 0 );
...
void
mynest::ps_aeif_cond_exp::handle( DataLoggingRequest& e )
{
  B_.logger_.handle( e );
}
