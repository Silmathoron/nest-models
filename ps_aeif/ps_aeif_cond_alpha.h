/*
 *  ps_aeif_cond_alpha.h
 *
 *  Changes Parameters_, changing State_;
 *
 */

#ifndef PS_AEIF_COND_ALPHA_H
#define PS_AEIF_COND_ALPHA_H
...
/* BeginDocumentation
Name: ps_aeif_cond_alpha - Perfect integrate-and-fire neuron model with alpha PSC synapse.

Description:
ps_aeif_cond_alpha implements a non-leaky integrate-and-fire neuron with
...
extern "C" int ps_aeif_cond_alpha_dynamics( double, const double*, double*, void* );

class ps_aeif_cond_alpha : public nest::Archiving_Node
{
   public:
      /**
      ...
      */
      ps_aeif_cond_alpha( const ps_aeif_cond_alpha& );
   ...
   private:
      ...
      friend class nest::UniversalDataLogger< ps_aeif_cond_alpha >;
   ...
   public:
      ...
      */
      struct Buffers_
      {
         Buffers_( ps_aeif_cond_alpha& );                  //!<Sets buffer pointers to 0
         Buffers_( const Buffers_&, ps_aeif_cond_alpha& ); //!<Sets buffer pointers to 0
      ...
      */
      ...
      static nest::RecordablesMap< ps_aeif_cond_alpha > recordablesMap_;

      /** @} */
};

inline nest::port
mynest::ps_aeif_cond_alpha::send_test_event( nest::Node& target,
...
inline nest::port
mynest::ps_aeif_cond_alpha::handles_test_event( nest::SpikeEvent&, nest::port receptor_type )
{
  // You should usually not change the code in this function.
...
inline nest::port
mynest::ps_aeif_cond_alpha::handles_test_event( nest::CurrentEvent&, nest::port receptor_type )
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline nest::port
mynest::ps_aeif_cond_alpha::handles_test_event( nest::DataLoggingRequest& dlr, nest::port receptor_type )
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline void
ps_aeif_cond_alpha::get_status( DictionaryDatum& d ) const
{
...
inline void
ps_aeif_cond_alpha::set_status( const DictionaryDatum& d )
{
...
#endif /* #ifndef PS_AEIF_COND_ALPHA_H */
