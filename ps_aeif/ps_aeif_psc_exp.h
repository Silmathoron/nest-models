...
#ifndef PS_AEIF_PSC_EXP_H
#define PS_AEIF_PSC_EXP_H
...
extern "C" int ps_aeif_psc_exp_dynamics( double, const double*, double*, void* );

class ps_aeif_psc_exp : public nest::Archiving_Node
{
   public:
      /**
      ...
      */
      ps_aeif_psc_exp( const ps_aeif_psc_exp& );
   ...
   private:
      ...
      friend class nest::RecordablesMap< ps_aeif_psc_exp >;
      friend class nest::UniversalDataLogger< ps_aeif_psc_exp >;
   ...
   public:
      ...
      */
      struct Buffers_
      {
         Buffers_( ps_aeif_psc_exp& );                  //!<Sets buffer pointers to 0
         Buffers_( const Buffers_&, ps_aeif_psc_exp& ); //!<Sets buffer pointers to 0

         //! Logger for all analog data
         nest::UniversalDataLogger< ps_aeif_psc_exp > logger_;
      ...
      */
      ...
      static nest::RecordablesMap< ps_aeif_psc_exp > recordablesMap_;

      /** @} */
};

inline nest::port
mynest::ps_aeif_psc_exp::send_test_event( nest::Node& target,
...
inline nest::port
mynest::ps_aeif_psc_exp::handles_test_event( nest::SpikeEvent&, nest::port receptor_type )
{
  // You should usually not change the code in this function.
...
inline nest::port
mynest::ps_aeif_psc_exp::handles_test_event( nest::CurrentEvent&, nest::port receptor_type )
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline nest::port
mynest::ps_aeif_psc_exp::handles_test_event( nest::DataLoggingRequest& dlr, nest::port receptor_type )
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline void
ps_aeif_psc_exp::get_status( DictionaryDatum& d ) const
{
...
inline void
ps_aeif_psc_exp::set_status( const DictionaryDatum& d )
{
...
#endif /* #ifndef PS_AEIF_PSC_EXP_H */
