...
#ifndef PS_AEIF_PSC_ALPHA_H
#define PS_AEIF_PSC_ALPHA_H
...
/* BeginDocumentation
Name: ps_aeif_psc_alpha - Current-based exponential integrate-and-fire
...
extern "C" int ps_aeif_psc_alpha_dynamics( double, const double*, double*, void* );

class ps_aeif_psc_alpha : public nest::Archiving_Node
{
   public:
      /**
      ...
      */
      ps_aeif_psc_alpha( const ps_aeif_psc_alpha& );
   ...
   private:
      ...
      friend class nest::RecordablesMap< ps_aeif_psc_alpha >;
      friend class nest::UniversalDataLogger< ps_aeif_psc_alpha >;
   ...
   public:
      ...
      */
      struct Buffers_
      {
         Buffers_( ps_aeif_psc_alpha& );                  //!<Sets buffer pointers to 0
         Buffers_( const Buffers_&, ps_aeif_psc_alpha& ); //!<Sets buffer pointers to 0

         //! Logger for all analog data
         nest::UniversalDataLogger< ps_aeif_psc_alpha > logger_;
      ...
      */
      ...
      static nest::RecordablesMap< ps_aeif_psc_alpha > recordablesMap_;

      /** @} */
};

inline nest::port
mynest::ps_aeif_psc_alpha::send_test_event( nest::Node& target,
...
inline nest::port
mynest::ps_aeif_psc_alpha::handles_test_event( nest::SpikeEvent&, nest::port receptor_type )
{
  // You should usually not change the code in this function.
...
inline nest::port
mynest::ps_aeif_psc_alpha::handles_test_event( nest::CurrentEvent&, nest::port receptor_type )
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline nest::port
mynest::ps_aeif_psc_alpha::handles_test_event( nest::DataLoggingRequest& dlr, nest::port receptor_type )
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline void
ps_aeif_psc_alpha::get_status( DictionaryDatum& d ) const
{
...
inline void
ps_aeif_psc_alpha::set_status( const DictionaryDatum& d )
{
...
#endif /* #ifndef PS_AEIF_PSC_ALPHA_H */
