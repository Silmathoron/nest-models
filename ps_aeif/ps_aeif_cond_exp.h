...
#ifndef PS_AEIF_COND_EXP_H
#define PS_AEIF_COND_EXP_H
...
/* BeginDocumentation
Name: ps_aeif_cond_exp - Perfect integrate-and-fire neuron model with alpha PSC synapse.

Description:
ps_aeif_cond_exp implements a non-leaky integrate-and-fire neuron with
...
extern "C" int ps_aeif_cond_exp_dynamics( double, const double*, double*, void* );

class ps_aeif_cond_exp : public nest::Archiving_Node
{
   public:
      /**
      ...
      */
      ps_aeif_cond_exp( const ps_aeif_cond_exp& );
   ...
   private:
      ...
      friend class nest::RecordablesMap< ps_aeif_cond_exp >;
      friend class nest::UniversalDataLogger< ps_aeif_cond_exp >;
   ...
   public:
      ...
      */
      struct Buffers_
      {
         Buffers_( ps_aeif_cond_exp& );                  //!<Sets buffer pointers to 0
         Buffers_( const Buffers_&, ps_aeif_cond_exp& ); //!<Sets buffer pointers to 0

         //! Logger for all analog data
         nest::UniversalDataLogger< ps_aeif_cond_exp > logger_;
      ...
      */
      ...
      static nest::RecordablesMap< ps_aeif_cond_exp > recordablesMap_;

      /** @} */
};

inline nest::port
mynest::ps_aeif_cond_exp::send_test_event( nest::Node& target,
...
inline nest::port
mynest::ps_aeif_cond_exp::handles_test_event( nest::SpikeEvent&, nest::port receptor_type )
{
  // You should usually not change the code in this function.
...
inline nest::port
mynest::ps_aeif_cond_exp::handles_test_event( nest::CurrentEvent&, nest::port receptor_type )
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline nest::port
mynest::ps_aeif_cond_exp::handles_test_event( nest::DataLoggingRequest& dlr, nest::port receptor_type )
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline void
ps_aeif_cond_exp::get_status( DictionaryDatum& d ) const
{
...
inline void
ps_aeif_cond_exp::set_status( const DictionaryDatum& d )
{
...
#endif /* #ifndef PS_AEIF_COND_EXP_H */
