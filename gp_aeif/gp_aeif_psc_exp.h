...
#ifndef GP_AEIF_PSC_EXP_H
#define GP_AEIF_PSC_EXP_H
...
extern "C" int gp_aeif_psc_exp_dynamics( double, const double*, double*, void* );

class gp_aeif_psc_exp : public nest::Archiving_Node
{
   public:
      /**
      ...
      */
      gp_aeif_psc_exp( const gp_aeif_psc_exp& );
   ...
   private:
      ...
      friend class nest::RecordablesMap< gp_aeif_psc_exp >;
      friend class nest::UniversalDataLogger< gp_aeif_psc_exp >;
   ...
   public:
      ...
      */
      struct Buffers_
      {
         Buffers_( gp_aeif_psc_exp& );                  //!<Sets buffer pointers to 0
         Buffers_( const Buffers_&, gp_aeif_psc_exp& ); //!<Sets buffer pointers to 0

         //! Logger for all analog data
         nest::UniversalDataLogger< gp_aeif_psc_exp > logger_;
      ...
      */
      ...
      static nest::RecordablesMap< gp_aeif_psc_exp > recordablesMap_;

      /** @} */
};

inline nest::port
mynest::gp_aeif_psc_exp::send_test_event( nest::Node& target,
...
inline nest::port
mynest::gp_aeif_psc_exp::handles_test_event( nest::SpikeEvent&, nest::port receptor_type )
{
  // You should usually not change the code in this function.
...
inline nest::port
mynest::gp_aeif_psc_exp::handles_test_event( nest::CurrentEvent&, nest::port receptor_type )
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline nest::port
mynest::gp_aeif_psc_exp::handles_test_event( nest::DataLoggingRequest& dlr, nest::port receptor_type )
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline void
gp_aeif_psc_exp::get_status( DictionaryDatum& d ) const
{
...
inline void
gp_aeif_psc_exp::set_status( const DictionaryDatum& d )
{
...
#endif /* #ifndef GP_AEIF_PSC_EXP_H */
