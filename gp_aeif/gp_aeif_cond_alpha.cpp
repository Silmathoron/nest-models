/*
 *  gp_aeif_cond_alpha.cpp
 *
 */

#include "gp_aeif_cond_alpha.h"
...
nest::RecordablesMap< mynest::gp_aeif_cond_alpha > mynest::gp_aeif_cond_alpha::recordablesMap_;
...
namespace nest // template specialization must be placed in namespace
{
  ...
  template <>
  void
  RecordablesMap< mynest::gp_aeif_cond_alpha >::create()
  {
    insert_( names::V_m, &mynest::gp_aeif_cond_alpha::get_y_elem_< mynest::gp_aeif_cond_alpha::State_::V_M > );
    insert_( names::g_ex, &mynest::gp_aeif_cond_alpha::get_y_elem_< mynest::gp_aeif_cond_alpha::State_::G_EXC > );
    insert_( names::g_in, &mynest::gp_aeif_cond_alpha::get_y_elem_< mynest::gp_aeif_cond_alpha::State_::G_INH > );
    insert_( names::w, &mynest::gp_aeif_cond_alpha::get_y_elem_< mynest::gp_aeif_cond_alpha::State_::W > );
  }
}
...
extern "C" int
mynest::gp_aeif_cond_alpha_dynamics( double, const double y[], double f[], void* pnode )
{
  // a shorthand
  typedef mynest::gp_aeif_cond_alpha::State_ S;

  // get access to node so we can almost work as in a member function
  assert( pnode );
  const mynest::gp_aeif_cond_alpha& node = *( reinterpret_cast< mynest::gp_aeif_cond_alpha* >( pnode ) );
...
mynest::gp_aeif_cond_alpha::Parameters_::Parameters_()
...
mynest::gp_aeif_cond_alpha::State_::State_( const Parameters_& p )
  : r_( 0 )
  , r_offset_ ( 0. )
{
  y_[ 0 ] = p.E_L;
...
mynest::gp_aeif_cond_alpha::State_::State_( const State_& s )
  : r_( s.r_ )
...
mynest::gp_aeif_cond_alpha::State_& mynest::gp_aeif_cond_alpha::State_::operator=( const State_& s )
{
...
void
mynest::gp_aeif_cond_alpha::Parameters_::get( DictionaryDatum& d ) const
{
...
void
mynest::gp_aeif_cond_alpha::Parameters_::set( const DictionaryDatum& d )
{
...
void
mynest::gp_aeif_cond_alpha::State_::get( DictionaryDatum& d ) const
{
...
void
mynest::gp_aeif_cond_alpha::State_::set( const DictionaryDatum& d, const Parameters_& )
{
...
mynest::gp_aeif_cond_alpha::Buffers_::Buffers_( gp_aeif_cond_alpha& n )
  : logger_( n )
  , s_( 0 )
  , c_( 0 )
  , e_( 0 )
...
mynest::gp_aeif_cond_alpha::Buffers_::Buffers_( const Buffers_&, gp_aeif_cond_alpha& n )
  : logger_( n )
  , s_( 0 )
  , c_( 0 )
  , e_( 0 )
...
mynest::gp_aeif_cond_alpha::gp_aeif_cond_alpha()
  : Archiving_Node()
  , P_()
  , S_( P_ )
  , B_( *this )
...
mynest::gp_aeif_cond_alpha::gp_aeif_cond_alpha( const gp_aeif_cond_alpha& n )
  : Archiving_Node( n )
  , P_( n.P_ )
  , S_( n.S_ )
  , B_( n.B_, *this )
...
void
mynest::gp_aeif_cond_alpha::init_state_( const Node& proto )
{
  const gp_aeif_cond_alpha& pr = downcast< gp_aeif_cond_alpha >( proto );
  S_ = pr.S_;
}

void
mynest::gp_aeif_cond_alpha::init_buffers_()
{
  ...
  B_.sys_.function = gp_aeif_cond_alpha_dynamics;
...
void
mynest::gp_aeif_cond_alpha::calibrate()
{
...
void
mynest::gp_aeif_cond_alpha::interpolate_( double& t, double t_old )
{
...
void
mynest::gp_aeif_cond_alpha::spiking_( const long_t lag, const double t )
{
  // spike event
  SpikeEvent se;
...
void
mynest::gp_aeif_cond_alpha::handle( SpikeEvent& e )
{
...
void
mynest::gp_aeif_cond_alpha::handle( CurrentEvent& e )
{
  assert( e.get_delay() > 0 );
...
void
mynest::gp_aeif_cond_alpha::handle( DataLoggingRequest& e )
{
  B_.logger_.handle( e );
}
