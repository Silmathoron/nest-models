...
nest::RecordablesMap< mynest::gp_aeif_psc_exp > mynest::gp_aeif_psc_exp::recordablesMap_;
...
namespace nest // template specialization must be placed in namespace
{
  ...
  template <>
  void
  RecordablesMap< mynest::gp_aeif_psc_exp >::create()
  {
    insert_( names::V_m, &mynest::gp_aeif_psc_exp::get_y_elem_< mynest::gp_aeif_psc_exp::State_::V_M > );
    insert_( names::I_ex, &mynest::gp_aeif_psc_exp::get_y_elem_< mynest::gp_aeif_psc_exp::State_::I_EXC > );
    insert_( names::I_in, &mynest::gp_aeif_psc_exp::get_y_elem_< mynest::gp_aeif_psc_exp::State_::I_INH > );
    insert_( names::w, &mynest::gp_aeif_psc_exp::get_y_elem_< mynest::gp_aeif_psc_exp::State_::W > );
  }
}
...
extern "C" int
mynest::gp_aeif_psc_exp_dynamics( double, const double y[], double f[], void* pnode )
{
  // a shorthand
  typedef mynest::gp_aeif_psc_exp::State_ S;

  // get access to node so we can almost work as in a member function
  assert( pnode );
  const mynest::gp_aeif_psc_exp& node = *( reinterpret_cast< mynest::gp_aeif_psc_exp* >( pnode ) );
...
mynest::gp_aeif_psc_exp::Parameters_::Parameters_()
...
mynest::gp_aeif_psc_exp::State_::State_( const Parameters_& p )
  : r_( 0 )
  , r_offset_ ( 0. )
{
  y_[ 0 ] = p.E_L;
...
mynest::gp_aeif_psc_exp::State_::State_( const State_& s )
  : r_( s.r_ )
...
mynest::gp_aeif_psc_exp::State_& mynest::gp_aeif_psc_exp::State_::operator=( const State_& s )
{
...
void
mynest::gp_aeif_psc_exp::Parameters_::get( DictionaryDatum& d ) const
{
...
void
mynest::gp_aeif_psc_exp::Parameters_::set( const DictionaryDatum& d )
{
...
void
mynest::gp_aeif_psc_exp::State_::get( DictionaryDatum& d ) const
{
...
void
mynest::gp_aeif_psc_exp::State_::set( const DictionaryDatum& d, const Parameters_& )
{
...
mynest::gp_aeif_psc_exp::Buffers_::Buffers_( gp_aeif_psc_exp& n )
  : logger_( n )
  , s_( 0 )
  , c_( 0 )
  , e_( 0 )
...
mynest::gp_aeif_psc_exp::Buffers_::Buffers_( const Buffers_&, gp_aeif_psc_exp& n )
  : logger_( n )
  , s_( 0 )
  , c_( 0 )
  , e_( 0 )
...
mynest::gp_aeif_psc_exp::gp_aeif_psc_exp()
  : Archiving_Node()
  , P_()
  , S_( P_ )
  , B_( *this )
...
mynest::gp_aeif_psc_exp::gp_aeif_psc_exp( const gp_aeif_psc_exp& n )
  : Archiving_Node( n )
  , P_( n.P_ )
  , S_( n.S_ )
  , B_( n.B_, *this )
...
void
mynest::gp_aeif_psc_exp::init_state_( const Node& proto )
{
  const gp_aeif_psc_exp& pr = downcast< gp_aeif_psc_exp >( proto );
  S_ = pr.S_;
}

void
mynest::gp_aeif_psc_exp::init_buffers_()
{
  ...
  B_.sys_.function = gp_aeif_psc_exp_dynamics;
...
void
mynest::gp_aeif_psc_exp::calibrate()
{
...
void
mynest::gp_aeif_psc_exp::interpolate_( double& t, double t_old )
{
...
void
mynest::gp_aeif_psc_exp::spiking_( const long_t lag, const double t )
{
  // spike event
  SpikeEvent se;
...
void
mynest::gp_aeif_psc_exp::update( const Time& origin, const nest::long_t from, const nest::long_t to )
{
...
void
mynest::gp_aeif_psc_exp::handle( SpikeEvent& e )
{
...
void
mynest::gp_aeif_psc_exp::handle( CurrentEvent& e )
{
  assert( e.get_delay() > 0 );
...
void
mynest::gp_aeif_psc_exp::handle( DataLoggingRequest& e )
{
  B_.logger_.handle( e );
}
