...
class gp_aeif_cond_alpha : public nest::Archiving_Node
{
   public:
      /**
      ...
      */
      gp_aeif_cond_alpha( const gp_aeif_cond_alpha& );
   ...
   public:
      ...
      */
      struct Buffers_
      {
         Buffers_( gp_aeif_cond_alpha& );                  //!<Sets buffer pointers to 0
         Buffers_( const Buffers_&, gp_aeif_cond_alpha& ); //!<Sets buffer pointers to 0

         //! Logger for all analog data
         nest::UniversalDataLogger< gp_aeif_cond_alpha > logger_;
      ...
      */
      ...
      static nest::RecordablesMap< gp_aeif_cond_alpha > recordablesMap_;

      /** @} */
};

inline nest::port
mynest::gp_aeif_cond_alpha::send_test_event( nest::Node& target,
...
inline nest::port
mynest::gp_aeif_cond_alpha::handles_test_event( nest::SpikeEvent&, nest::port receptor_type )
{
  // You should usually not change the code in this function.
...
inline nest::port
mynest::gp_aeif_cond_alpha::handles_test_event( nest::CurrentEvent&, nest::port receptor_type )
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline nest::port
mynest::gp_aeif_cond_alpha::handles_test_event( nest::DataLoggingRequest& dlr, nest::port receptor_type )
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline void
gp_aeif_cond_alpha::get_status( DictionaryDatum& d ) const
{
...
inline void
gp_aeif_cond_alpha::set_status( const DictionaryDatum& d )
{
